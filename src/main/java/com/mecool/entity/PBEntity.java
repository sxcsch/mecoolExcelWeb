 ...
 */
public class PBEntity implements Serializable{
    ...
    public PageData getFzHeard() {
        return fzHeard;
    }

    public void setFzHeard(PageData fzHeard) {
        this.fzHeard = fzHeard;
    }
